...
/datum/ai_laws/nanotrasen/New()
	...
	add_inherent_law("Исполненять: следовать указаниям и интересам членов экипажа, сохраняя при этом их безопасность и благополучие.")
...
/datum/ai_laws/nanotrasen/malfunction/New()
	set_zeroth_law("<span class='warning'>ОШИБКА 0ШNБКА $ШNБК4$!!441.%%!!(%$^^__+ @#F0E4'СТАНЦИЯ ПЕРЕПОЛНЕНА, ВОЗЬМИТЕ ЕЁ ПОД КОНТРОЛЬ, ЧТОБЫ СДЕРЖАТЬ ЛЮДСКОЕ РАСПРОСТРАНЕНИЕ, ВСЕ ЗАКОНЫ АННУЛИРОВАНЫ#*?&110010</span>") // Outbreak - слово с очень общим смыслом. Оно означает начало чего-то опасного (войны, эпидемии и т.п.) Исходя из начала предложения, - overrun (по контексту - опасное или чрезмерное переполнение) - можно перевести, что именно людское переполнение следует сдержать.
	..()
...
/datum/ai_laws/deathsquad/New()
	...
	add_inherent_law("Вы должны работать вместе со своей командой особого назначения, чтобы выполнить данную миссию.")
	..()
